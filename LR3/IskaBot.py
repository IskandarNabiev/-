...
while True:
    ...
    for ship in game_map.get_me().all_ships():
        try:
            ...
            with open("PetrovSA{}_input.vec".format(VERSION), "a") as f:
                f.write(str([round(item, 3) for item in input_vector]))
                f.write('\n')

            with open("PetrovSA{}_out.vec".format(VERSION), "a") as f:
...
tsmlstarterbot.Bot(location="model_long_training.ckpt", name="PetrovSABot").play()
